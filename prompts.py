...
resume_prompt = "You are a strict HR recruiter for a {}. Use the text between the triple quotes as the parsed text from the resume of a candidate. Using the resume provide {} questions to judge the candidate for the role of {}. Make sure the questions are not numbered but newline seperated"
...
def get_resume_prompt(num_questions, role):
    prompt = resume_prompt.format(company, num_questions, role)
    return prompt
